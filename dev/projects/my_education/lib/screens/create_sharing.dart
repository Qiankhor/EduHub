...
class RegisterSharingSessionPage extends StatefulWidget {
  @override
  _RegisterSharingSessionPageState createState() => _RegisterSharingSessionPageState();
}

class _RegisterSharingSessionPageState extends State<RegisterSharingSessionPage> {
    ...
    if (currentUser != null) {
      ...
      if (_file != null) {
        try {
          ...
          ).ref().child('teacher/files/${capitalizeFirstLetter(_nameController.text.trim())}'); // Change extension if needed
