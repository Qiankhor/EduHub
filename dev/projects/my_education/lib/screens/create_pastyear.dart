  ...
  Future<void> _pickPdf() async {
    ...
    if (result != null && result.files.single.path != null) {
      setState(() {
        ...
        _fileName =
            path.basename(result.files.single.path!); // Extract PDF name
      });
    }
  }
...
// Helper methods to get category, subject, and year values based on selection
  ...
  String _getSubjectValue() {
    return _selectedSubject == 'Other'
        ? _subjectController.text.trim()
        : _selectedSubject ?? '';
  }

  String _getYearValue() {
    return _selectedYear == 'Other'
      ...
      body: Center(
        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            padding: EdgeInsets.symmetric(vertical: 20), // Consistent padding
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: Text(
                    'You will receive 15 points if the past year question is approved by the admin.',
                    style: GoogleFonts.poppins(
                      fontSize: 12,
