...
import 'package:my_education/screens/promotional.dart';
        ...
        if (mounted) {
          setState(() {
            eventData = data.entries
                ...
                .where((item) =>
                    item['approve'] == true) // Filter for approved items
                .toList();
          });
        }
      } else {
                  ...
                  children: [
                    TextSpan(
                      ...
                      style: TextStyle(
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
                          color: Colors.black), // Target Audience的颜色
                    ),
                    TextSpan(
                      text: '${eventData['targetAudience'] ?? 'Unknown'}',
                      style: TextStyle(
                          fontSize: 20, color: Colors.grey[600]), // 值的颜色
                    ),
                  ],
                ),
              ),
