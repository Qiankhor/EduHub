...
import 'package:my_education/screens/point_transaction_page.dart';
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        backgroundColor: _profilePicUrl == null ||
                            ...
                            ? Colors.orange[
                                100] // Light blue background for the initial
                            : Colors
                                .transparent, // No background if profile picture exists
                        child: _profilePicUrl == null || _profilePicUrl!.isEmpty
                            ? Text(
                                ...
                                style: TextStyle(
                                  ...
                                  color: Colors.orange[
                                      800], // Dark blue text for contrast
                                ),
                              )
                            : null,
                      ...
                      Positioned(
                        ...
                        child: GestureDetector(
                          onTap:
                              _uploadProfilePic, // Change profile picture on tap
                          child: CircleAvatar(
                            radius: 15,
                            backgroundColor: Colors.orange[
                                700], // Set background color for the icon
                            child: Icon(
