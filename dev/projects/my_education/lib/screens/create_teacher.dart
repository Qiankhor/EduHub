          ...
          try {
            ...
            final fileStorageRef = FirebaseStorage.instanceFor(
              bucket: "myeducation-865f1.appspot.com",
                ...
                'tutor/files/${capitalizeFirstLetter(_nameController.text.trim())}_${capitalizeFirstLetter(_educationLevelController.text.trim())}.pdf'); // Change extension if needed
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildTextField(
                          _educationLevelController, 'Highest Education Level'),
                      _buildTextField(_yearController, 'Year of Experience',
                          isNumber: true),
                      _buildTextField(_calendarController, 'Date of Birth',
                          isCalendar: true),

                      SizedBox(height: 5),

                      _buildUploadContainer(
                          _pickImage, _imageName, 'Upload your resume photo'),
                      _buildUploadContainer(_pickPdf, _fileName,
...
// Helper method for file upload container
  Widget _buildUploadContainer(
      VoidCallback onPressed, String fileName, String defaultText) {
    return Container(
          ...
          children: [
            ...
            Expanded(
              child: TextButton(
                onPressed: onPressed,
                child: Text(
                  fileName.isEmpty ? defaultText : 'Selected: $fileName',
