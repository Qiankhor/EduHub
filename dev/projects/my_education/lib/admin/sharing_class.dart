...
class _ClassPageAdminState extends State<ClassPageAdmin> {
  final DatabaseReference _sharingRef = FirebaseDatabase.instance.ref().child('class');
...
Future<void> _removeSharing(String key, String providerId, Map<String, dynamic> item) async {
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text('Are you sure you want to reject this class? This action cannot be undone.'),
            SizedBox(height: 8),
            TextField(
...
Future<String> downloadPdf(String url) async {
  ...
  Future<void> _approveClass(String key, String providerId, Map<String, dynamic> item) async {
