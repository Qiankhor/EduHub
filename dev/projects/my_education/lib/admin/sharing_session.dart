...
class SharingSessionPageAdmin extends StatefulWidget {
  @override
  _SharingSessionPageAdminState createState() => _SharingSessionPageAdminState();
}
...
Future<void> _removeClass(String key, String providerId, Map<String, dynamic> item) async {
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text('Are you sure you want to reject this sharing session? This action cannot be undone.'),
            SizedBox(height: 8),
            TextField(
...
Future<String> downloadPdf(String url) async {
  ...
  Future<void> _approveSharing(String key, String providerId, Map<String, dynamic> item) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading // Check loading state first
          ...
          : sharingData!.isEmpty // If loading is complete, check if data is empty
              ? Center(
                  child: Text(
