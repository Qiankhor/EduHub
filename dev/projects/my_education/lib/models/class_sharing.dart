...
Future<void> _deductPoints(String userId, int points) async {
  ...
  DocumentReference providerRef = FirebaseFirestore.instance.collection('users').doc(widget.data['provider']);
  ...
  return await showDialog<bool>(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: Text('Submitting this will deduct ${widget.data['point']} points. Do you want to continue?'),
        actions: [
          TextButton(
            child: Text('Cancel'),
            onPressed: () {
                ...
                FutureBuilder<String>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      (onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>TeacherDetailPage(teacherData: widget.data)));
                      },
...
SizedBox(height: 10,),
              Align ( 
                ...
                Align ( 
                alignment: Alignment.centerLeft,
                child: Text('${widget.data['description'] ?? 'Unknown'}',style: TextStyle(color: Colors.grey),),
                ),
                SizedBox(height: 80,)
            ],
        ...
        Container(
            padding: EdgeInsets.all(25),
                ...
                child: userId != widget.data['provider'] ?ElevatedButton(
